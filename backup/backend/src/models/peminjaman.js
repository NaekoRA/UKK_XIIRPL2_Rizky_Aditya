...
const menyetujuiPeminjman = (id_data_peminjaman, id_petugas, status, callback) => {
    const q = "UPDATE data_peminjaman SET id_petugas = ?, status = ? WHERE id = ? AND status = 'menunggu';";
