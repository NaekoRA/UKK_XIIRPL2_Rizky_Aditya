...
router.put("/kategori/:id", authJWT, kategori_controller.updateKategori);
router.delete("/kategori/:id", authJWT, kategori_controller.deleteKategori);

router.get("/alat", alat_controller.getAllAlat);
router.get("/alat/:id", alat_controller.getAlatById);
router.post("/alat", authJWT, upload.single('img'), alat_controller.createAlat);
router.put("/alat/:id", authJWT, upload.single('img'), alat_controller.updateAlat);
router.delete("/alat/:id", authJWT, alat_controller.deleteAlat);
...
router.post("/peminjaman/:id_peminjam", authJWT("peminjam"), peminjaman_controller.mengajukanPeminjaman);
